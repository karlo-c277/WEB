...
export declare class NeatGradient implements NeatController {
    ...
    private _wmMoveRafPending;
    private _wmCachedRect;
    private _wmRectCacheTime;
    private _gradientVAO;
    private _watermarkVAO;
    ...
    _initScene(resolution: number, preserveDrawingBuffer?: boolean): WebGLState;
