...
export class NeatGradient {
    ...
    constructor(config) {
        ...
        // 3D shapes default
        shapeType = 'plane', shapeRotationX = 0, shapeRotationY = 0, shapeRotationZ = 0, shapeAutoRotateSpeedX = 0, shapeAutoRotateSpeedY = 0, sphereRadius = 15, torusRadius = 15, torusTube = 5, cylinderRadius = 10, cylinderHeight = 40, planeBend = 0, planeTwist = 0, licenseKey, preserveDrawingBuffer = false, antialias = false, } = config;
        this._ref = ref;
        ...
        const setSize = (width, height) => {
            ...
            if (this._ref.width === width && this._ref.height === height)
                return;
